        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <div class="card border-dark opacity-100 mx-auto">
                        
                        <div class="bg-primary card-header text-white fw-bold" style="text-align: center; "><img src="imagenes/logo-ITESS.png" alt="" height="100px" width="300px"></div>
                        <div class="bg-primary card-body ">
                          
                            <form action="" method="post">
                                <div class="mb-3">
                                    <label for="usuario" class="form-label text-white fw-bold">Usuario:</label>
                                    <input type="text" class="form-control" name="usuario" id="usuario" aria-describedby="helpId" placeholder="Usuario"/> 
                                </div>
                                <div class="mb-3">
                                        <label for="constrasenia" class="form-label text-white fw-bold">Constraseña:</label>
                                    ...
                                    id="boton"
                                    class="btn btn-fw-bold btn-dark btn-lg"
                                    type="submit"
                                    value="Entrar"
                                    />
                                <div>
